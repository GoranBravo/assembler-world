...
const Index: React.FC = () => {
  ...
  const [randomTaskId, setRandomTaskId] = useState(0);
      ...
      <ScrollView>
        <View style={styles.container}>
          ...
          <View style={styles.row}>
            <View
              style={[styles.textContainer, styles.boxBorder, styles.mRigth]}
            >
              ...
              {title ? (
                <>
                  ...
                  <DefaultButton
                    key={randomTaskId}
                    press={() =>
                      router.replace(`/task/${randomTaskId}` as Href)
                    }
                    color="#E47A17"
                    text={"Detalles"}
                    vertical={true}
            ...
            <View
              style={[styles.textContainer, styles.boxBorder, styles.mLeft]}
            >
              <ScrollView>
                {tasks.map((id) => (
                  <DefaultButton
